...
print(Guest_list)
print('This is the number of guests invited:', len(Guest_list))
message1 = 'Hello' 
...
print(Guest_list)
print('This is the new added number of total guests invited', len(Guest_list))
...
print("\n", Guest_list)
print('This is the number of guests that are still invited to dinner', len(Guest_list))
print("\n", GUESTS_POPPED)
print('This is the number of guests that have been popped', len(GUESTS_POPPED))
